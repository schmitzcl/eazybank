...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected @Nullable ResponseEntity<Object> handleHandlerMethodValidationException(HandlerMethodValidationException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
            ...
            parameterValidationResults.forEach((validationResult) -> {
                validationResult.getResolvableErrors().forEach((error) -> {
                    validationErrors.put(validationResult.getMethodParameter().getParameterName(), error.getDefaultMessage());
                });
            });
    ...
    public ResponseEntity<com.eazybytes.loans.dto.ErrorResponseDto> handleGlobalException(Exception exception,
